#  <p align="center">:robot:  project-group11:robot:  </p>     
...
:white_check_mark: git clone https://github.com/Dmytro-Ostrenko/project-group11-pyWeb-


3. Перейдіть в каталог проєкту:    
:white_check_mark:cd project-group11-pyWeb-
