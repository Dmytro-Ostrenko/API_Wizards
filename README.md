...
### Примітка:
Аутентифікація та авторизація: Відбувається реєстрація нового користувача з участю. Підтвердження пошти. Перший користувач у системі - "адміністратор", решта за умовчанням має роль "користувача". Роль може змінити "адміністратор".
